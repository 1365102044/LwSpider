...
class spiderCompositonTool:
    ...
    def __init__(self):
        self.db = pymysql.connect(host='123.57.213.168',
                                  user='root',
                                  password='1113',
                                  database='compostion',
                                  port=3306,
        ...
        list_table = 'CREATE TABLE IF NOT EXISTS t_compoistion_list(ID TEXT,catename TEXT,subcatename TEXT,title TEXT,tags TEXT,views TEXT,good TEXT,edittime TEXT,lengths TEXT,fl TEXT,fv TEXT)'
    ...
    def saveListDatas(self,listdata):
        for dict in listdata:
            sql = "insert into t_compoistion_list(ID,catename,subcatename,title,tags,views,good,edittime,lengths,fl,fv) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
